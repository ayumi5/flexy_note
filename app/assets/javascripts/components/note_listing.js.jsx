  ...
  render: function() {
    ...
    return (
      <div className='note-listing col-sm-11 col-sm-offset-1'>
        {Notes}
        <NoteCreateBox handleModalEdit={this.props.handleModalEdit} handleNoteSubmit={this.props.handleNoteSubmit} generateAlloyEditor={this.props.generateAlloyEditor} />
      </div>
    )
  }
});
